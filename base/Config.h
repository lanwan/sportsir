...
// Compiler Environment
   ...
   #include <msp430G2553.h>                                    // Target MCU
#else
...
#define IOBOARD_LED0_SEL                     P1SEL
#define IOBOARD_LED0_DIR                     P1DIR
#define IOBOARD_LED0_BIT                     BIT0           // P1.0
#define IOBOARD_LED0_OUT                     P1OUT
...
//------------------------------------------------------------------------------
// PORTSEL
#define SERIAL_PORTSEL_SEL                   P1SEL
#define SERIAL_PORTSEL_DIR                   P1DIR
#define SERIAL_PORTSEL_BIT                   BIT6           // P1.6
#define SERIAL_PORTSEL_OUT                   P1OUT

//------------------------------------------------------------------------------
// SFLOW
#define SERIAL_SFLOW_SEL                     P1SEL
#define SERIAL_SFLOW_DIR                     P1DIR
#define SERIAL_SFLOW_BIT                     BIT7           // P1.7
#define SERIAL_SFLOW_OUT                     P1OUT
...
// Asynchronous
#define ASYNC_RX_DIR                         P1DIR
#define ASYNC_RX_SEL                         P1SEL
#define ASYNC_RX_BIT                         BIT1           // P1.1 
#define ASYNC_RX_IN                          P1IN           // TX on ANT

#define ASYNC_TX_DIR                         P1DIR
#define ASYNC_TX_SEL                         P1SEL
#define ASYNC_TX_BIT                         BIT2           // P1.2
#define ASYNC_TX_OUT                         P1OUT          // RX on ANT

#define ASYNC_RTS_DIR                        P2DIR
#define ASYNC_RTS_SEL                        P2SEL
#define ASYNC_RTS_BIT                        BIT2           // P2.2
#define ASYNC_RTS_IN                         P2IN           // RTS on ANT

#define ASYNC_SUSPEND_DIR                    P1DIR
#define ASYNC_SUSPEND_SEL                    P1SEL
#define ASYNC_SUSPEND_BIT                    BIT4           // P1.4
#define ASYNC_SUSPEND_OUT                    P1OUT          // SUSPEND on ANT

#define ASYNC_SLEEP_DIR                      P1DIR
#define ASYNC_SLEEP_SEL                      P1SEL
#define ASYNC_SLEEP_BIT                      BIT5           // P1.5
#define ASYNC_SLEEP_OUT                      P1OUT          // SLEEP on ANT
